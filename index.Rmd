...
leaflet(datos) %>%
  ...
  addLayersControl(baseGroups = c("OpenStreetMap", "Stamen Toner Lite", "CartoDB DarkMatter"),
                   overlayGroups = c("Registros", "Registros Titi", "Distritos con registros", "Densidad", "ASP", "Área de Conservación", "Red Vial"),
                   options = layersControlOptions(collapsed = TRUE))  %>%
  addScaleBar() %>%
  hideGroup(c("Distritos con registros", "Registros Titi", "Densidad", "ASP", "Área de Conservación", "Red Vial")) %>%
  addMiniMap(
    toggleDisplay = TRUE,
    position = "bottomleft",
